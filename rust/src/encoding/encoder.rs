...
pub fn create_encoder(data_type: TSDataType, encoding: TSEncoding) -> Box<dyn Encoder> {
    match encoding {
        ...
        _ => {
            // Fall back to plain encoding for unsupported types
            log::warn!(
                "Unsupported encoding {:?} for type {:?}, falling back to Plain",
                encoding,
                data_type
            );
...
// =========================================================================
// RLE Encoder (simplified)
// =========================================================================

/// Run-Length Encoding encoder (simplified implementation).
...
// =========================================================================
// TS_2DIFF Encoder (simplified delta-of-delta)
// =========================================================================
...
// =========================================================================
// Gorilla Encoder (simplified XOR-based float encoding)
// =========================================================================
...
impl GorillaEncoder {
    ...
    fn write_bits(&mut self, value: u64, num_bits: u8) {
        ...
        while remaining > 0 {
            ...
            self.bit_buf |= ((v >> (remaining - to_write)) as u8) << shift;
